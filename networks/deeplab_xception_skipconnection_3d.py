...
class DeepLabv3_plus_skipconnection_3d(nn.Module):
    def __init__(self, nInputChannels=3, n_classes=21, os=16, pretrained=False, _print=True, final_sigmoid=False,
        ...
        # self.feature_projection_conv2 = nn.Conv3d(16, 32, 1, bias=False)
        # if normalization == 'bn':
        #     self.feature_projection_bn2 = nn.BatchNorm3d(32)
        # elif normalization == 'gn':
        #     self.feature_projection_bn2 = nn.GroupNorm(num_groups=num_groups, num_channels=32)
        #
        # self.decoder1 = nn.Sequential(Decoder_module(152, 128, normalization=normalization, num_groups=num_groups),
        #                              Decoder_module(128, 128, normalization=normalization, num_groups=num_groups))
        # self.decoder2 = nn.Sequential(Decoder_module(160, 128, normalization=normalization, num_groups=num_groups),
        #                               Decoder_module(128, 128, normalization=normalization, num_groups=num_groups))
