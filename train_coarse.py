...
def get_parser():
    ...
    parser.add_argument("--gcn_mode", type=int, default=2,
                        help="the mode for fea2graph and graph2fea, only available for gcn. 0, 1, 2. 0: Graphonomy,"
                             " 2: SpineParseNet")

    parser.add_argument("--ds_weight", type=float, default=0.3,
                        help="The deep supervision weight (i.e., lambda in paper) used in fea2graph when gcn_mode is 2.")
